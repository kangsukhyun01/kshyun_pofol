{
    ...
    class Item {
        ...
        layout() {
            // scale the image
            this.DOM.image.style.transform = `scale(${this.renderedStyles.imageScale.previous},${this.renderedStyles.imageScale.previous})`;
            // translate the title
    ...
    class SmoothScroll {
        constructor() {
            // the <main> element
            this.DOM = {
                main: document.querySelector('#scroll_layout')
            };
        ...
        layout() {
            //변경점      // this.DOM.scrollable.style.transform = `translate3d(0,${-1*this.renderedStyles.translationY.previous}px,0)`;
        }
        setSize() {
        ...
        style() {
            ...
            this.DOM.main.style.position = 'sticky';
...
// let conItWide=document.querySelectorAll(".content__item--wide")
// let conItImg=document.querySelectorAll(".content__item-img")
// let conItTit=document.querySelectorAll(".content__item-title")
